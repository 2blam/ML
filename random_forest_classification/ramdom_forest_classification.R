# random forest (classification) by 2blam

# set working directory
setwd("~/Documents/GitHub/ML/random_forest_classification")
...
set.seed(1234)
classifier = randomForest(x=training_set[-3], y=training_set$Purchased, data=training_set, ntree=10)
